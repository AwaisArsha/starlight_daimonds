        ...
        <div class="das_left">
            <div class="das_inr">
                <div class="das_pagi">
                    <h1>Buffing Form</h1>
                    <div class="add_btn">
                        <a class="add_bt_fm" href="{{url('buffinghistory')}}"><i class="fa fa-angle-double-left"></i></a>
                    </div>
                </div>
                <div class="from_panel">
                    <form method="POST" action="{{ url('buffingform') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="from_bx">
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="input_frm">
                                            <label>Dust</label>
                                            <input type="text" placeholder="Enter here" id="dust" name="dust" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <div class="input_frm">
